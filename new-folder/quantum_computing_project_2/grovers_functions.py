...
class Simulator:
    ...
    """
    grover_simplified uses custom made gates e.g. the R0 gate, a proper Grover iteration will need to be made using actual quantum gates
    It is simply a method to test out whether Grover's algorithm actually works
    """
    @staticmethod
